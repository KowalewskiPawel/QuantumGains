export const MOCK_LLAVA_EXERCISE_AND_FAT_RESPONSE = {
    fatLevel: 25,
    trainingProgramList: [
        {
            day: "Monday",
...
export const MOCK_LLAVA_DIET_RESPONSE = {
    diet: [
        {
            day: "Monday",
            meals: {
                ...
                "evening-snack": "1 cup of Greek yogurt with berries",
        ...
        },
        {
            ...
            meals: {
                ...
                "evening-snack": "1 cup of cottage cheese with berries",
